        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {projects.map((project, i) => (
            <div key={project.title} data-aos="fade-up" data-aos-delay={i * 100}
              className="bg-white/5 border border-white/10 rounded-2xl p-8 flex flex-col gap-4 hover:border-[#ff2a2a]/50 hover:bg-white/8 transition-all duration-300 group">
              ...
              <div className="flex items-start justify-between">
                ...
                <a href={project.github} target="_blank" rel="noopener noreferrer"
                  className="text-white/40 hover:text-white transition-colors duration-300 shrink-0 mt-1">
              ...
              <div className="flex flex-wrap gap-2 mt-auto pt-2">
                {project.tech.map(t => (
                  <span key={t} className="px-3 py-1 rounded-full bg-[#ff2a2a]/10 border border-[#ff2a2a]/20 text-[#ff2a2a] text-xs font-semibold">
                    {t}
                  </span>
                ))}
              </div>
              ...
              <a href={project.github} target="_blank" rel="noopener noreferrer"
                className="mt-2 w-full py-3 rounded-xl border border-white/10 text-white/60 text-sm font-semibold text-center hover:border-[#ff2a2a]/50 hover:text-white transition-all duration-300">
                View on GitHub →
              </a>
