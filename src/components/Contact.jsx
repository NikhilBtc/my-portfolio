        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div data-aos="fade-left" data-aos-delay="200">
            <div className="flex flex-col gap-5">
              ...
              <button
                className="w-full py-4 rounded-xl bg-[#ff2a2a] text-white font-bold text-sm uppercase tracking-widest hover:bg-red-700 transition-all duration-300 hover:scale-[1.02]">
                Send Message
              </button>
            </div>
          </div>
