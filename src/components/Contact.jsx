          ...
          <form className="flex flex-col gap-12 md:gap-16 w-full">
            ...
            <div className="flex flex-col md:flex-row gap-12 mt-4">
              <div className="flex-1 flex items-start gap-4 text-sm font-medium text-white/90">
                <input type="checkbox" id="permission" className="mt-1 w-4 h-4 cursor-pointer" style={{ accentColor: "white" }} />
              ...
              <div className="flex-1 flex flex-col gap-8 text-xs text-white/70 font-medium">
                <div className="flex flex-col sm:flex-row sm:justify-end sm:items-end gap-6">
                  <button type="submit" className="px-8 py-3 rounded-full border border-white/40 text-white font-bold flex items-center justify-center gap-3 hover:bg-white hover:text-[#ff2a2a] transition-all duration-300 group whitespace-nowrap self-start">
                    Send
